...
import com.nearapps.library.keyboard_simple.Keyboard.Key;
 ...
 *
 * @attr ref android.R.styleable#keyboard_simpleView_keyBackground
 * @attr ref android.R.styleable#keyboard_simpleView_keyPreviewLayout
 * @attr ref android.R.styleable#keyboard_simpleView_keyPreviewOffset
 * @attr ref android.R.styleable#keyboard_simpleView_keyPreviewHeight
 * @attr ref android.R.styleable#keyboard_simpleView_labelTextSize
 * @attr ref android.R.styleable#keyboard_simpleView_keyTextSize
 * @attr ref android.R.styleable#keyboard_simpleView_keyTextColor
 * @attr ref android.R.styleable#keyboard_simpleView_verticalCorrection
 * @attr ref android.R.styleable#keyboard_simpleView_popupLayout
 *
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private static final int[] LONG_PRESSABLE_STATE_SET = { R.styleable.keyboard_simpleViewPreviewState_android_state_long_pressable };
...
//    private AccessibilityManager mAccessibilityManager;
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.keyboard_simpleView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.keyboard_simpleView_android_keyBackground) {
                mKeyBackground = a.getDrawable(attr);
            } else if (attr == R.styleable.keyboard_simpleView_android_verticalCorrection) {
                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
            } else if (attr == R.styleable.keyboard_simpleView_android_keyPreviewLayout) {
                previewLayout = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.keyboard_simpleView_android_keyPreviewOffset) {
                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
            } else if (attr == R.styleable.keyboard_simpleView_android_keyPreviewHeight) {
                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
            } else if (attr == R.styleable.keyboard_simpleView_android_keyTextSize) {
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
            } else if (attr == R.styleable.keyboard_simpleView_android_keyTextColor) {
                mKeyTextColor = a.getColor(attr, 0xFF333333);
            } else if (attr == R.styleable.keyboard_simpleView_android_labelTextSize) {
                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
            } else if (attr == R.styleable.keyboard_simpleView_android_popupLayout) {
                mPopupLayout = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.keyboard_simpleView_android_shadowColor) {
                mShadowColor = a.getColor(attr, 0);
            } else if (attr == R.styleable.keyboard_simpleView_android_shadowRadius) {
